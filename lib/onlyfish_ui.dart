...
class Onlyfish extends StatelessWidget {
  ...
  final ImageProvider elish_product;
  final ImageProvider rupchada_product;
  final ImageProvider koral_product;
  final ImageProvider nodirkoral_product;
  final ImageProvider kalochada_product;
  final ImageProvider tuna_product;
  Onlyfish({
    Key key,
    ...
    this.elish_product = const AssetImage('assets/images/elish_product.png'),
    this.rupchada_product =
        const AssetImage('assets/images/rupchada_product.png'),
    this.koral_product = const AssetImage('assets/images/koral_product.png'),
    this.nodirkoral_product =
        const AssetImage('assets/images/nodirkoral_product.png'),
    this.kalochada_product =
        const AssetImage('assets/images/kalochada_product.jpg'),
    this.tuna_product = const AssetImage('assets/images/tuna_product.jpg'),
  }) : super(key: key);
  @override
